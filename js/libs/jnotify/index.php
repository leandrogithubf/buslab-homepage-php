...
<body>
	<ul>
		<li>Full documentation on <a
			href="http://www.myjqueryplugins.com/jNotify">MyjQueryPlugins.com/jNotify</a></li>
		<li>Live demonstration on <a
			href="http://www.myjqueryplugins.com/jNotify/demo">jNotify
				demonstration page</a></li>
	</ul>
	<h1>jNotify plugin</h1>
	<p>
		<a href="#" class="success">It's a success !</a><br /> <a href="#"
			class="notice">It's a notice !</a><br /> <a href="#" class="error">It's
			an error !</a><br />
		<br /> <a href="#" class="three">Success, Notify and Error !!</a><br />
